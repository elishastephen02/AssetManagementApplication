...
namespace AssetManagement.Adapter
{
    public class SQLiteAdapter
    {
        ...
        public DataTable GetMappedTable(string tableName, List<string> requiredColumns)
        {
            var existingColumns = GetColumns(tableName)
                                    .Select(c => c.ColumnName)
                                    .ToList();

            var validColumns = requiredColumns
            ...
            return GetTableData(tableName, validColumns);
        }
